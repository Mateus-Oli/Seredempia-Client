...
angular.module("helper").run(function($templateCache){
  ...
  $templateCache.put("views/helper.html",'<div class="help" ng-click="redirect(link)"><img ng-if="image" ng-style="{float:side}" class="img-help" ng-src={{image}}/><h4 style="margin:3%;"><b>{{title}}: </b><font ng-transclude></font><a ng-if="link" href={{link}}> Clique Aqui!</a></h4></div>');
});
